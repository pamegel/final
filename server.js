      ...
      function receivedPostback(event) {
        ...
        if(payload == 'findLocation'){
          ...
          +"\n วันเปิดปิด : เปิดทำการทุกวัน"
          +"\n คำอธิบาย : ลักษณะน้ำตกเป็นลำธารน้ำที่ไหลผ่านโขดหินน้อยใหญเป็นชั้นๆ สภาพทั่วไปเป็นป่าโปร่ง จุดเด่นของน้ำตกเขาอีโต้นั่นคือนักท่องเที่ยวสามารถเข้าไปนั่งพักผ่อนตามแนวโขดหินของตัวน้ำตก เพื่อสัมผัสกับสายน้ำที่ไหลผ่านตลอดแนวหิน"
          +"\n แผนที่ : ");
          fineHeres(senderID);
