      ...
      function receivedPostback(event) {
        ...
        if(payload == 'findLocation'){
          ...
          +"\n วันเปิดปิด : เปิดทำการทุกวัน"
          +"\n คำอธิบาย : เป็นลำธารน้ำที่ไหลผ่านโขดหินน้อยใหญเป็นชั้นๆ สภาพทั่วไปเป็นป่าโปร่ง ซึ่งนคุณสามารถเข้าไปนั่งพักผ่อนตามแนวโขดหินของตัวน้ำตก เพื่อสัมผัสกับสายน้ำที่ไหลผ่านตลอดแนวหิน"
          +"\n แผนที่ : ");
          fineHeres(senderID);
          ...
          +"\n วันเปิดปิด : เปิดทำการทุกวัน"
          +"\n คำอธิบาย : อ่างเก็บน้ำขนาดใหญ่อยู่บริเวณเชิงเขาอีโต้ จากปากทางเข้าอ่างเก็บน้ำให้เลี้ยวซ้ายจะมีถนนขึ้นไปจนถึงยอดเขาเพื่อชมทัศนียภาพโดยรอบ ระยะทางประมาณ 11 กิโลเมตร และช่วงกิโลเมตรที่ 6 จะเป็นเนินพิศวง"
          +"\n แผนที่ : ");
          fineHeres(senderID);
