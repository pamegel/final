      ...
      function receivedPostback(event) {
        ...
        if(payload == 'findLocation'){
          ...
          +"\n วันเปิดปิด : เปิดทำการทุกวัน"
          +"\n คำอธิบาย : นับว่าเป็นแหล่งกำเนิดของต้นน้ำลำธารที่ทำให้เกิดปรากฏการณ์ธรรมชาติ ที่เป็นแหล่งท่องเที่ยวที่สำคัญนั้นก็คือ น้ำตกที่สวยงาม มีน้ำตกน้อยใหญ่เกิดขึ้นหลายแห่งในพื้นที่อุทยานแห่งชาติเขาใหญ่ ซึ่งสำรวจพบและทำเส้นทางเดินเท้าไปถึงแล้วประมาณ 30 แห่ง"
          +"\n แผนที่ :");
          fineHeres(senderID);
