      ...
      function receivedPostback(event) {
        ...
        if(payload == 'findLocation'){
          ...
          +"\n วันเปิดปิด : เปิดทำการทุกวัน"
          +"\n แผนที่ :");
            sendTextMessage(senderID,":คำอธิบาย : อุทยานแห่งชาติเขาใหญ่นับว่าเป็นแหล่งกำเนิดของต้นน้ำลำธารที่ทำให้เกิดปรากฏการณ์ธรรมชาติ ที่เป็นแหล่งท่องเที่ยวที่สำคัญนั้นก็คือ น้ำตกที่สวยงาม มีน้ำตกน้อยใหญ่เกิดขึ้นหลายแห่งในพื้นที่อุทยานแห่งชาติเขาใหญ่ ซึ่งสำรวจพบและทำเส้นทางเดินเท้าไปถึงแล้วประมาณ 30 แห่งที่มีความสวยงามแตกต่างกันไปตามสภาพธรรมชาติของภูมิประเทศเป็นที่รู้จักกันดี"
          fineHeres(senderID);
