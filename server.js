        ...
        function receivedPostback(event) {
          ...
          if(payload == 'findLocation'){
            ...
            +"\n คำอธิบาย : ดาษดา แกลเลอรี่ เป็นชื่อของสถานที่ท่องเที่ยวที่ไ้ด้ชื่อว่าเป็น สวรรค์ขรือนกระจกขนาดใหญ่ ในรูปแบบของแกลเลอรี่ดอกไม้ "
            +"\n แผนที่ : ");
            fineHeres(senderID);
          }
            ...
            +"\n วันเปิดปิด : เปิดทำการทุกวัน"
            +"\n คำอธิบาย :  ิดขึ้นหลายแห่งในพื้นที่อุทยานแห่งชาติเขาใหญ่ ซึ่งสำรวจพบและทำเส้นทางเดินเท้ห่ง     ที่มีความสวยงามแตกต่างกันไปตามสภาพธรรมชาติของภูมิประเทศเป็นที่รู้จักกันดี"
            +"\n แผนที่ :");
            fineHeres(senderID);
            ...
            +"\n วันเปิดปิด : เปิดทำการทุกวัน"
            +"\n คำอธิบาย : โรงพยาบาลเจ้าพระยาอภัยภูเบศรมีฐานะเป็นโรงพภูมิ เช่น เดียวกับโรงพยาบาลศูนย์ทั่ว ๆ ไป แต่สิ่งที่โรงพสมุนไพรและการแพทย์แผนไทยเข้าสู่ระบบบริการสุขภาพของโรงพยาบาล รวมทั้งเพื่อพัฒนาเป็นเศรษฐกิจของชุมชนและออกสู่ตลาดโลก"
            +"\n แผนที่ : ");
            fineHeres(senderID);
