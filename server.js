      ...
      function receivedPostback(event) {
        ...
        if(payload == 'findLocation'){
          ...
          +"\n คำอธิบาย : เป็นชื่อของสถานที่ท่องเที่ยวที่ได้ชื่อว่าเป็น สวรรค์ของคนรักดอกไม้นานาพรรณ ที่นี่มีการนำพันธุ์ไม้ดอกและไม้ประดับหลากหลายชนิด มาจัดแสดงในเรือนกระจกขนาดใหญ่ "
          +"\n แผนที่ : ");
          fineHeres(senderID);
        }
          ...
          +"\n วันเปิดปิด : เปิดทำการทุกวัน"
          +"\n คำอธิบาย : ช้อป ชิว และยังมีมุมถ่ายรูปสวยๆอีกเพียบ ไม่ว่าจะมากับครอบครัว คนรู้ใจหรือจะเดินเล่นติสๆ คนเดียวก็เข้าที รวมถึงอร่อยกับร้านอาหารสไตท์ปิ้ง-ย่าง-ชาบู ลานเบียร์ และอื่นๆอีกมากมากมาย ช่วงเย็นก็นั่งจิบเบียร์ชมดนตรีที่ลานเบียร์ได้เลย"
          +"\n แผนที่ : ");
          fineHeres(senderID);
          ...
          +"\n เวลาทำการ : เวลาเปิดทำการ 08.00 - 17.00 น."
          +"\n วันเปิดปิด : เปิดทำการทุกวัน"
          +"\n คำอธิบาย : เป็นเส้นทางล่องแก่งที่มีระดับความยากอยู่ที่ 3-5 บนระยะทางรวมกว่า 4.5 กิโลเมตร ซึ่งต้องใช้เวลาผจญภัยอยู่บนสายน้ำทั้งสิ้นประมาณ 2 ชั่วโมง มีลานหินหักที่เทตัวลงมาทำให้เกิดเป็นวังน้ำวนไหลเชี่ยวผ่านแก่งหินต่างๆ ระยะทางกว่า 200 เมตร"
          +"\n แผนที่ : ");
          fineHeres(senderID);
          ...
          +"\n วันเปิดปิด : เปิดทำการทุกวัน"
          +"\n คำอธิบาย : ลักษณะน้ำตกเป็นลำธารน้ำที่ไหลผ่านโขดหินน้อยใหญ่ลดหลั่นเป็นชั้นๆ สภาพทั่วไปเป็นป่าโปร่ง จุดเด่นของน้ำตกเขาอีโต้นั่นคือนักท่องเที่ยวสามารถเข้าไปนั่งพักผ่อนตามแนวโขดหินของตัวน้ำตก เพื่อสัมผัสกับสายน้ำที่ไหลผ่านตลอดแนวหิน"
          +"\n แผนที่ : ");
          fineHeres(senderID);
