  ...
  function receivedPostback(event) {
    ...
    if(payload == 'findLocation'){
      ...
      fineHeres(senderID);
      sendTextMessage(senderID, "คำอธิบาย\nดาษดา แกลเลอรี่ เป็นชื่อของสถานที่ท่องเที่ยวที่ไ้ด้ชื่อว่าเป็น สวรรค์ของคนรักดอกไม้นานาพรรณ เพราะที่นี่มีการนำพันธุ์ไม้ดอกและไม้ประดับหลากหลายชนิด มาจัดแสดงในเรือนกระจกขนาดใหญ่ ในรูปแบบของแกลเลอรี่ดอกไม้ "
    }
